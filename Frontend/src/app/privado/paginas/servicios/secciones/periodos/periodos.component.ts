...
import { FicheroPeriodosComponent } from "../../../../../core/componentes/ficheros/periodos/fichero-periodos.component";
...
export class PeriodosComponent {
  ...
  abrirModal() {
    ...
    this.modalService.obtenerInstancia().onConfirmar.subscribe(() => {
      this.ficheroPeriodos.cargarDatosServidor();
    });
  }
}
