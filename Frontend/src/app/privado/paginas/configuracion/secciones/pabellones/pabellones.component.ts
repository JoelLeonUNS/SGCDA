...
import { TablaPagEditarEstadoPabellonesComponent } from '../../../../../core/componentes/tablas/paginada/editar-estado/pabellones/tabla-pag-editar-estado-pabellones.component';

@Component({
    selector: 'app-pabellones',
    standalone: true,
    templateUrl: './pabellones.component.html',
    styleUrl: './pabellones.component.css',
    ...
    imports: [
        ...
        NzSpaceModule,
        NzPageHeaderModule,
        TablaPagEditarEstadoPabellonesComponent,
...
export class PabellonesComponent {
  ...
  @ViewChild('tablaPabellones') tablaPabellones!: TablaPagEditarEstadoPabellonesComponent;
